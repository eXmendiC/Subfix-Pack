...
if "%timing%" EQU "1" (
 py -3 audio\prass\prass.py copy-styles --resample --from audio\%template% --to "%scriptname%" | py -3 audio\prass\prass.py shift --by 33ms -o "%scriptname%_tmp.ass"
 goto AMZ
)
...
if "%timing%" EQU "2" (
 py -3 audio\prass\prass.py copy-styles --resample --from audio\%template% --to "%scriptname%" | py -3 audio\prass\prass.py shift --by 66ms -o "%scriptname%_tmp.ass"
 goto AMZ
)
...
if "%timing%" EQU "24" (
 py -3 audio\prass\prass.py copy-styles --resample --from audio\%template% --to "%scriptname%" | py -3 audio\prass\prass.py shift --by 792ms -o "%scriptname%_tmp.ass"
 goto AMZ
)
